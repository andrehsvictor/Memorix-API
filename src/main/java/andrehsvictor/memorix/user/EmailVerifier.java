...
public class EmailVerifier {
    ...
    public void sendVerificationEmail(String baseUrl, String email) {
        ...
        String url = baseUrl + (baseUrl.contains("?") ? "&" : "?") + "token=" + token;
        String body = fileUtil.processTemplate("classpath:templates/verify-email.html",
                Map.of("url", url, "expiration", formatDuration(lifetime)));
